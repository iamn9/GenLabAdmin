...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        id!!}/update'>
                            ...
                            <input type="number" id="qty" name="qty" min="1" value="{!!$cart_item->qty!!}">
                    ...
                    <td>
                        ...
                        <!--<a class = 'viewEdit btn btn-warning btn-xs' href = '/cart_item/{!!$cart_item->id!!}/edit'><i class="fa fa-pencil-square-o" aria-hidden="true"></i>  Edit</a>-->
